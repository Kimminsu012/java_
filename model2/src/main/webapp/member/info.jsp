...
<c:if test="${user.image != null }">
	<c:set var="img" value="style='background:url(http://192.168.0.29/static/img/${user.image }) no-repeat center; background-size:cover;'"/>
</c:if>
	...
	<form method="post" action="/members/infoUpdate" enctype="multipart/form-data">
		...
		<div id="grid">
			...
			<div class="item login_history">
				...
				<c:forEach var="res" items="${login_list }">	
					<li>
						<span class="login_date date">${res.login_date }</span>
