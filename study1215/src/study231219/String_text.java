...
public class String_text {
	...
	public static void main(String[] args) {
		...
		String orange = song.replaceAll("바나나", "오렌지");
		System.out.println( orange );
		
		String al = song.substring(song.indexOf(" ")+1, song.indexOf("알러지") );
		System.out.println(al);
		
		String song2 = "상상만 해도 웃음이 나요 ";
		System.out.println( song2.concat(song) );
